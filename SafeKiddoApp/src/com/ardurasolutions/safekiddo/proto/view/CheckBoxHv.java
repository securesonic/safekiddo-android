...
public class CheckBoxHv extends CheckBox {
	
	private Object extraInfo;
	
	public CheckBoxHv(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		if (!isInEditMode())
			setCustomFont(context, attrs);
	}
	
	public CheckBoxHv(Context context, AttributeSet attrs) {
		super(context, attrs);
		if (!isInEditMode())
			setCustomFont(context, attrs);
	}
	
	public CheckBoxHv(Context context) {
		super(context);
		if (!isInEditMode())
