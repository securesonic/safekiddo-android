...
public class CheckedTextViewHv extends CheckedTextView {

	public CheckedTextViewHv(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		if (!isInEditMode())
			setCustomFont(context, attrs);
	}
	
	public CheckedTextViewHv(Context context, AttributeSet attrs) {
		super(context, attrs);
		if (!isInEditMode())
			setCustomFont(context, attrs);
	}
	
	public CheckedTextViewHv(Context context) {
		super(context);
		if (!isInEditMode())
