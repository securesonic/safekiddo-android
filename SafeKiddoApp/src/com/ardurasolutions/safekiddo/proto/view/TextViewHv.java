...
public class TextViewHv extends TextView {

	public TextViewHv(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		if (!isInEditMode())
			setCustomFont(context, attrs);
	}
	
	public TextViewHv(Context context, AttributeSet attrs) {
		super(context, attrs);
		if (!isInEditMode())
			setCustomFont(context, attrs);
	}
	
	public TextViewHv(Context context) {
		super(context);
		if (!isInEditMode())
